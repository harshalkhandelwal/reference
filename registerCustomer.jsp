...
<head>
<title>CapStore : Register as Customer</title>
    ...
    function Validate() {
	 ...
	 <section>
			...
			<!---728x90--->
				<div class="graphs">
					<div class="sign-up">
						<h1>Create an account as Customer</h1>
						...
						<div class="sign-u">
							...
							<div class="sign-up2">
								<form:input path="customerName" type="text" maxlength="30" placeholder="Enter customer name" required="required"/>
						...
						<div class="sign-u">
							...
							<div class="sign-up2">
								...
								<form:input path="customerEmail" type="text" pattern="[a-z0-9._%+-]+@[a-z]+\.[a-z]{2,}$" placeholder="Enter email-id" required="required"/>
						...
						<div class="sign-u">
							...
							<div class="sign-up2">
							<form:input path="customerMobileNumber" type="text" title="mobile number should be of 10 digits" pattern="^\d{10}$" placeholder="Enter mobile number" required="required"/>
							...
							<div class="sign-up2">
									...
									<form:input path="customerAddress" type="text" placeholder="Enter Address" required="required"/>
							...
							<div class="sign-up2">
									...
									<form:input path="customerPincode" type="text" title="the pincode must be of 6 digits" pattern="^\d{6}$" placeholder="Enter pin code" required="required"/>
						...
						<div class="sign-u">
							...
							<div class="sign-up2">
									...
									<input name="password" id="txtPassword" type="password" title="the password must contain atleast one uppercase, one lowercase and digits and must be atleast 8 characters" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"  placeholder="Enter 8 characters password" required="required"/>
						...
						<div class="sign-u">
							...
							<div class="sign-up2">
									...
									<input name="confpassword" id="txtConfirmPassword" title="the password must contain atleast one uppercase, one lowercase and digits and must be atleast 8 characters" type="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" placeholder="Confirm password" required="required"/>
